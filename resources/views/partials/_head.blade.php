...
<head>
    ...
    <script src="{{url('')}}/css/kybarg/js/bootstrap-dropdownhover.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="{{url('')}}/css/kybarg/css/bootstrap-dropdownhover.min.css">
