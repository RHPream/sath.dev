...
@section('breadcrumbs')
    <ul class="page-breadcrumb">
        <li>
            <a href="{{url('/home')}}">Class wise preparation</a>
...
@section('title')
    <h1 class="page-title"> Class wise preparation
        <small>Recent Class wise preparation</small>
    </h1>
@endsection
            ...
            <div class="portlet-body form" style="min-height: 500px;">
                ...
                @foreach($subjects as $subject)
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin: 10px;">
                        <a class="dashboard-stat dashboard-stat-v2 blue"  href="{{url('preparation').'/'.$subject->id}}">
                            <div class="visual">
                                <i class="fa fa-globe"></i>
                            </div>
                            <div class="details">
                                <div class="number"></div>
                                <div class="desc"> {{$subject->name}} </div>
                            </div>
                        </a>
                    </div>
            @endforeach
