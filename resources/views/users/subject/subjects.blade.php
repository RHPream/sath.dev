    ...
    <div class="row">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>All Subjects of your class. </div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body form" style="min-height: 500px;">
                ...
                @foreach($subjects as $l)
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin: 10px;">
                        <a class="dashboard-stat dashboard-stat-v2 blue"  data-toggle="modal" data-target="#myModal{{$l->id}}">
                            <div class="visual">
                            ...
                            <div class="details">
                                ...
                                <div class="desc" style="font-size: 20px;">Class: {{$l->class_output($l->id)->name}} </div>
                            </div>
                        </a>
                    </div>
