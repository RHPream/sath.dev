...
@section('title')
    <h1 class="page-title"> Circulars
        <small>Recent Edit Circulars</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Edit Circular </div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form method="POST" id="users_add" action="{{route('circular.update',$circular->id)}}" class="form-horizontal">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="unit" class="form-control" placeholder="Enter unit" value="{{old('unit')?old('unit'):$circular->unit}}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" class="form-control" id="description" cols="30" rows="10">{{old('description')?old('description'):$circular->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label">News</label>
                        <div class="col-md-9">
                            <input type="text" name="marque" class="form-control" placeholder="Enter news" value="{{old('marque')?old('marque'):$circular->marque}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label">Link</label>
                        <div class="col-md-9">
                            <input type="text" name="link" class="form-control" placeholder="Enter link" value="{{old('link')?old('link'):$circular->link}}">
                        </div>
                    </div>
