    ...
    <div class="page-toolbar">
        <div class="form-actions">
            <div class="btn-set pull-left">
                <a href="{{url('admin/chapter/create')}}" class="btn btn-primary">Add Chapter</a>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Chapters </div>
            <div class="tools"> </div>
        </div>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-left" role="menu">
                                    <li>
                                        <a href="{{url('admin/chapter').'/'.$chapter->id.'/edit'}}">
                                            <i class="glyphicon glyphicon-edit"></i> Edit </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" class="row-delete" id="{{$chapter->id}}">
