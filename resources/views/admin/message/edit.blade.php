...
@section('breadcrumbs')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{url('')}}/admin/users">Messages</a>
        </li>
    </ul>
    <div class="page-toolbar">
        <div class="form-actions">
            <div class="btn-set pull-left">
                <a href="{{url('admin/message')}}" class="btn btn-primary">Messages</a>
            </div>
        </div>
    </div>
@endsection
...
@section('title')
    <h1 class="page-title"> Messages
        <small>Recent Edit Messages</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe"></i>Edit Messages </div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form method="POST" id="users_add" action="{{route('message.update',$message->id)}}" class="form-horizontal">
                {{csrf_field()}}
                {{method_field('PATCH')}}
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="subject" class="form-control" placeholder="Enter Name" value="{{old('subject')?old('subject'):$message->subject}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label">Message</label>
                        <div class="col-md-9">
                            <textarea name="message" class="form-control" id="description" cols="30" rows="10">{{old('message')?old('message'):$message->message}}</textarea>
                        </div>
                    </div>
                </div>
